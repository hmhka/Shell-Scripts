...
# sender’s real or effective UID matches the real or saved UID of the receiver.
#
...
# Memory size: 32544 Megabytes
      ...
      swap -l                 # Details of the system’s virtual swap space
...
# Display the list of the connected users only if
# the monitoring duration is shorter than LongRun:
  test "$ShortRun" = "yes" && \
...
#+$ECHO "T\n1\n4\n3"       #  4. Processes/Clients 3. Active Transactions
  $ECHO "T\n1\n5"          #  5. Status: Files
# $ECHO "T\n1\n6\n1"       #  6. Status: Lock Table
#+$ECHO "T\n1\n7"          #  7. Status: Buffer Cache
  $ECHO "T\n1\n8"          #  8. Status: Logging Summary
#+$ECHO "T\n1\n9"          #  9. Status: BI Log
  $ECHO "T\n1\n10"         # 10. Status: AI Log
# $ECHO "T\n1\n11"         # 11. Status: Two-Phase Commit
  $ECHO "T\n1\n12"         # 12. Status: Startup Parameters
# $ECHO "T\n1\n13"         # 13. Status: Shared Resources
  $ECHO "T\n1\n14"         # 14. Status: Shared Memory Segments
# $ECHO "T\n1\n15"         # 15. Status: AI Extents
#+$ECHO "T\n1\n16"         # 16. Status: Database Service Manager
  $ECHO "T\n1\n17"         # 17. Status: Servers By Broker
# $ECHO "T\n1\n18"         # 18. Client Database-Request Statement Cache ...
  test "$StCaDir" && test -d $StCaDir && \
  $ECHO "T\n1\n18\n8\n$StCaDir" # 8. Specify Directory for Statement Cache Files
# $ECHO "T\n1\n19"         # 19. Status: Schema Locks & Wait Queue   V10.2B04
  $ECHO "T\n1\n20\n\n\n\n\n" # 20. Status: Broker Startup Parameters

#  4. Administrative Functions ...  ---------------------------

# $ECHO "T\n4\n1"          #  1. Check Active Transaction Status
# $ECHO "T\n4\n2"          #  2. Check Two-Phase Transactions
# $ECHO "T\n4\n3"          #  3. Resolve Limbo Transactions
  $ECHO "T\n4\n4"          #  4. Adjust Latch Options
# $ECHO "T\n4\n5"          #  5. Adjust Page Writer Options
# $ECHO "T\n4\n6"          #  6. Restricted Options
# $ECHO "T\n4\n7"          #  7. Server Options
  $ECHO "T\n4\n8"          #  8. Enable/Disable block level consistency check
# $ECHO "T\n4\n11"         # 11. Adjust Governor options
...
#   $ECHO "T\n1\n15"       # 15. Status: AI Extents
    $ECHO "T\n1\n16"       # 16. Status: Database Service Manager
#   $ECHO "T\n1\n17"       # 17. Status: Servers By Broker
#   $ECHO "T\n1\n18"       # 18. Status: Client Database-Request Statement Cache ...
#   $ECHO "T\n1\n19"       # 19. Status: Schema Locks & Wait Queue
#   $ECHO "T\n1\n20"       # 20. Status: Broker Startup Parameters

#  2. Activity Displays ... ---------------------------

    $ECHO "T\n2\n1"        #  1. Activity: Summary
#   $ECHO "T\n2\n2${MANY}" #  2. Activity: Servers
    $ECHO "T\n2\n3"        #  3. Activity: Buffer Cache
    $ECHO "T\n2\n4"        #  4. Activity: Page Writers
    $ECHO "T\n2\n5"        #  5. Activity: BI Log
    $ECHO "T\n2\n6"        #  6. Activity: AI Log
    $ECHO "T\n2\n7"        #  7. Activity: Lock Table
    $ECHO "T\n2\n8"        #  8. Activity: I/O Operations by Type
#   $ECHO "T\n2\n9${MANY}" #  9. Activity: I/O Operations by File
    $ECHO "T\n2\n10"       # 10. Activity: Space Allocation
    $ECHO "T\n2\n11"       # 11. Activity: Index
    $ECHO "T\n2\n12"       # 12. Activity: Record
    $ECHO "T\n2\n13"       # 13. Activity: Other

#  3. Other Displays ...   ---------------------------

    $ECHO "T\n3\n1"        # 1. Performance Indicators
#   $ECHO "T\n3\n2"        # 2. I/O Operations by Process
#   $ECHO "T\n3\n3"        # 3. Lock Requests By User
    $ECHO "T\n3\n4"        # 4. Checkpoints
#   $ECHO "T\n3\n5"        # 5. I/O Operations by User by Table
#   $ECHO "T\n3\n6"        # 6. I/O Operations by User by Index
#   $ECHO "T\n3\n7"        # 7. Total Locks per User

#  6. This menu is not here ------------------------

#   $ECHO "T\n6\n1"        #  1. Status: Cache Entries
#   $ECHO "T\n6\n2"        #  2. Status: Hash Chain
#   $ECHO "T\n6\n3"        #  3. Status: Page Writer Queue
#   $ECHO "T\n6\n4"        #  4. Status: Lru Chains
#   $ECHO "T\n6\n5"        #  5. Status: Locked Buffers
#   $ECHO "T\n6\n6"        #  6. Status: Buffer Locks
#   $ECHO "T\n6\n7"        #  7. Status: Buffer Use Counts
    $ECHO "T\n6\n8"        #  8. Activity: Resource Queues
    $ECHO "T\n6\n9"        #  9. Activity: TXE Lock Activity
#   $ECHO "T\n6\n10"       # 10. Adjust TXE Options
    $ECHO "T\n6\n11"       # 11. Activity: Latch Counts
#   $ECHO "T\n6\n12"       # 12. Activity: Latch Times
#   $ECHO "T\n6\n13"       # 13. Activity: I/O Wait Time by Type
#   $ECHO "T\n6\n14"       # 14. Activity: I/O by File
...
# Input stream:
#
# 03/28/16        Activity: I/O Operations by File
# 12:20:09        03/28/16 12:19 to 03/28/16 12:20 (10 sec)
...
#
# 03/28/16        Status: Blocked Clients [by user number for all tenants]
# 12:20:09
#   Usr Name     Type      Wait        Wait Info  Trans id   Login time
#  2710 USER1    SELF/ABL  BKEX       7499376640 2062034534  03/28/16 12:20
#  3051 USER2    SELF/ABL  BKEX       7499376640 2062028166  03/28/16 09:55
#  3633          SELF/ABL  BKEX       7499376640 2062034633  03/28/16 12:20
#
# 03/28/16        Status: Buffer Lock Queue [by user number for all tenants]
# 12:20:09
#   User               DBKEY Area T         Status           Type     Usect
#  1353                  192    6 S         LOCKED           EXCL         1
#  3249                  192    6 S        WAITING       EXCLWAIT
#  7415           7499377024    8 D         LOCKED           EXCL         1
#  2216           7499377024    8 D        WAITING       EXCLWAIT
